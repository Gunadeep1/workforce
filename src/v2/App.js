...
import OTP from './layouts/otp/OTP';
import ResetPassword from './layouts/changePassword/ResetPassword'
...
import NewSignUp from './layouts/signUp/NewSignUp';
        ...
        <BrowserRouter>
          {LocalStorage.getAccessToken() ? (
            ...
            <Routes>
              ...
              <Route path="/submit-otp" element={<OTP />} />
