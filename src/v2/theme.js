...
export const BrownMnCustomStepIconSignup = (props) => {
  const classes = makeStyles();
  const { active, completed } = props;
  const stepIcons = {
    1: <img src={active ? bdactive : completed ? bdCompleted : ''} alt='Organization Details ' height='20px' width='20px' />,
    2: <img src={active ? bdactive : completed ? bdCompleted : dempty} alt='Personal Details' height='20px' width='20px' />,
  };
