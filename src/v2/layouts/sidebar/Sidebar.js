                ...
                <Box component={"section"} className={`${classes.sidebar} ${sidebar.open ? classes.sidebarOpen : null}`}>
                    ...
                    <ul className={classes.sideMenu}>
                        ...
                        <li>
                            ...
                            >
                                <Link to={"/placements/dashboard"} className={`${classes.sidebarLink} ${placementRoutes.includes(location.pathname)? classes.sidebarLinkActive : null}`} onClick={handleClose}>
