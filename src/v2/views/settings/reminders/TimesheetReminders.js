...
import { Box, Divider, Stack, Avatar, Skeleton, Badge, Grid, Menu, MenuItem, Slide, } from '@mui/material';
...
import TimesheetIcon from '../../../assets/svg/timesheetorg.svg';
...
const timesheetData = [
    {
        ...
        "description": "Siva Sai Krishna",
        "submitted_by": "Siva Sai Krishna",
    },
    {
        "slug": "expense",
        "title": "Pending  Approval",
        "description": "Siva Sai , Rnaga K ",
        "submitted_by": "Siva Sai Krishna",
    }
]

export default function TimesheetReminders() {
            ...
            <Stack className={classes.mainContainer}>
                <Stack className={classes.header}>
                    ...
                    <Stack className={classes.leftHeader}>
                        ...
                        <Text className={classes.header1}>Timesheet Reminders</Text>
                    </Stack>
                    ...
                    {timesheetData.length !== 0 && !loading ? timesheetData.map((data, index) => (
                        <Grid container className={classes.notificationCard} rowSpacing={{ md: 0, sm: 5, xs: 5 }} key={index}>
                            <Grid item lg={5} md={5} sm={6} xs={12} className={classes.leftContent} container >
                                <Avatar src={TimesheetIcon} alt='icons' className={classes.avatarSize} />
                                <Stack gap={1}>
                                    <Text className={classes.header2}><StyledBadge badgeContent={'02'} >{data.title}</StyledBadge></Text>
                            ...
                            <Grid item lg={3} md={3} sm={6} xs={12} container justifyContent={{ lg: 'center', md: 'center', sm: 'start' }} pl={{ lg: 12, sm: 0 }}>
                                <Stack gap={1}>
                                    <Text className={classes.header4}>Submitted By</Text>
                                    <Text className={classes.header5}>{data.submitted_by}</Text>
                                </Stack>
                            </Grid>
                            ...
                            <ReusablePopup iconHide openPopup={view} setOpenPopup={handleApproveClose} white statusWidth >
                                <Box>
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '15px', flexDirection: 'row', paddingBottom: '20px' }}>
                                        <Button className={classes.viewAllBtn} onClick={() => setView('form')} >View all Reminders</Button>
