                ...
                <Box className={classes.activeItemBox} >
                    ...
                    <Box sx={{ minHeight: "30vh", overflow: 'auto' }}>
                        ...
                        <Grid container spacing={2} columnSpacing={4}>
                            ...
                            <Grid item lg={12} md={12} sm={12} xs={12}>
                                <Box py={1} my={1}>
                                    <Textarea className={classes.textarea} type="text" name="terms_and_conditions" aria-label="minimum height" minRows={6} onChange={changeHandler} placeholder="Additional Information" disabled={isEditable} />
