...
import Category from './preferences/Category';

const prefernces = ['Category'];

function EmployeeSelfServiceConfig() {
            ...
            <Box padding={'20px 0px 0px 0px'} width={{ sm: '95%', md: '85%', lg: '85%' }}>
                <Grid container columnSpacing={{ xs: 1, sm: 2, md: 3 }} >
                    ...
                    <Grid item lg={8} md={8} sm={8} xs={12}>
                        ...
                        <Box >
                            {
                                current === "Category" ? <Category current={'Employee Self Service'} /> : null
                            }
                        </Box>
...
export default EmployeeSelfServiceConfig;
