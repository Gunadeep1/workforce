...
function WorkAuthorizationDocuments({ current }) {
  ...
  const templateFormHandler = () => (
    <Box padding={'38px 30px 35px 30px '}>
      <Box mb={4}>
        <Text blackHeader1>Add Invoice Template</Text>
      </Box>
      ...
      <Grid container mt={'32px'}>
        <Grid item container alignItems={'center'} >
          <Checkbox icon={<CheckBorderIcon />} checkedIcon={<CheckedIcon />} />
          <Text>Enable This Reminder</Text>
        </Grid>
      </Grid>
...
export default WorkAuthorizationDocuments;
