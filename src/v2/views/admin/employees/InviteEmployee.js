...
export default function AddEmployee() {
    ...
    const validateAll = () => {
        const { first_name, last_name, email_id, contact_number, dob, gender, offer_letter_id, middle_name } = state
        let errors = {}
            ...
            <Box>
                ...
                <Box sx={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <Box sx={{ width: "45%", display: "flex", justifyContent: "end", alignItems: "center", padding: "20px 10px", gap: 2 }}>
                        <Button blackCancel onClick={() => { setValue(0); navigate(-1) }}>Cancel</Button>
                        {
                            value == 1 ?
