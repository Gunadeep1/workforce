            ...
            <Grid item lg={7}>
              <Box display="flex" alignItems="center">
                ...
                <Box ml={2}>
                  ...
                  <Text smallBlack sx={{ color: '#737373 !important', paddingTop: '5px !important', fontFamily: "Nunito , Nunito Sans, sans-serif !important" }} nowrap>{reference_id} - {visa}</Text>
                </Box>
              </Box>
            </Grid>
            <Grid item lg={5}>
                  ...
                  <Grid item container>
                    ...
                    <Grid item container spacing={3} pt={3}>
                      <Grid item lg={9}>
                        ...
                        <Text boldBlackfont16 sx={{ font: '24px Nunito Sans, sans-serif !important', }}>{getCurrencySymbol()}{" "}{get1.balance_amount ? get1.balance_amount.toFixed(2) : 0}</Text>
                      </Grid>
                      <Grid item lg={3}>
                        {get1.balance_amount ?
                          (<>
