...
import ImmigrationSvg from "../../../../../assets/svg/immigration.svg";
...
export default function EducationDocs() {
    ...
    const [state, setState] = useState(
        // {
        //     "relationship_id": "@Id_from_relationship_types",
        //     "first_name": "@_Alphabet",
        //     "last_name": "@_Alphabet",
        //     "middle_name": "Alphabet",
        //     "email_id": "Email",
        //     "contact_number": "Formate_(XXX-XXX-XXXX)",
        //     "dob": "@_Date",
        //     "visa_type_id": "@_Id_from_visa_types",
        //     "ssn": "@_ssn",
        //     "passport_new_document_id": "@_Id_from_temp_upload_documents",
        //     "i94_new_document_id": "@_Id_from_temp_upload_documents"
        //   }
                    ...
                    </Typography>
                    {
                        !["add", "update"].includes(form) ?
                            <Box display={"flex"} justifyContent={"end"} gap={"10px"}>
                                <Button save>Initiate</Button>
                                <Button outlineBlue>Upload</Button>
                            </Box> : null
                    }
                </Box>
                    ...
                    ["add", "update"].includes(form) ? (
                        <Fragment>
                            ...
                            <Box my={2} px={1} display={"flex"} justifyContent={"end"} gap={3}>
                                {
                                    ["add", "update"].includes(form) ?
                                        <Button cancel onClick={() => setForm(false)}>
                                            Cancel
                                        </Button> : null
                                }
                                            ...
                                            accordionSummary={
                                                ...
                                                >
                                                    <Box display={'flex'} alignItems={'center'} >
                                                        <img src={ImmigrationSvg} alt="passport" />
