...
function ReusablePopup(props) {
    ...
    const { title, children, openPopup, setOpenPopup, scrollTrue, close, iconHide, fullWidth, fixedWidth, white, statusWidth, crossIcon, width1000 } = props;
    ...
    return (
        <Dialog open={openPopup} classes={{ paper: fullWidth ? classes.dialogWrapper1 : fixedWidth ? classes.fixedWidth : statusWidth ? classes.statusWidth : width1000 ? classes.width1000 : classes.dialogWrapper }}
