...
function Text(props) {
    ...
    const { children,
        ...
        largeGreyTxt, mediumBlackColor, greyLabel,
        cardTitle,
        smallBlue1,
        boldBlackfont16, verySmallBlack,
        boldBlackfont22,
        popupHead1,popupHead2,dashboardTitle,pieDetails,roleText,employeeAdded,greenText,statesText,
        smallGreyText,
        blackHeader18, mediumBlack14,
        blackHeader,mediumBoldBlack2,lightGrey3,mediumGrey2,blackHeader1,
        mediumBoldWhite,largeBoldGreen,loginHeader,forgotPasswordDesc,passwordReqHeader,reSendFont,
        infoText,
        ...rest
    } = props
    ...
    const btnClasses = classNames({
        ...
        [classes.dashboardTitle]:dashboardTitle,
        [classes.pieDetails]:pieDetails,
        [classes.roleText]:roleText,
        [classes.employeeAdded]:employeeAdded,
        [classes.greenText]:greenText,
        [classes.statesText]:statesText,
        ...
        [classes.loginHeader]:loginHeader,
        [classes.forgotPasswordDesc]:forgotPasswordDesc,
        [classes.passwordReqHeader]:passwordReqHeader,
        [classes.reSendFont]:reSendFont,
    })
    return (
        <React.Fragment>
...
Text.propTypes = {
    ...
    dashboardTitle: PropTypes.bool,
    pieDetails: PropTypes.bool,
    roleText: PropTypes.bool,
    employeeAdded: PropTypes.bool,
    greenText: PropTypes.bool,
    statesText: PropTypes.bool,
    ...
    forgotPasswordDesc:PropTypes.bool,
    passwordReqHeader:PropTypes.bool,
    reSendFont:PropTypes.bool,
}
