...
export default function Input(props) {
  ...
  const {
    ...
    iconText,
    descriptionInput, helperText, popUpInput, InputSm, icon, tooltipTitle, smallWhiteInput, smallClientInput, tooltipField,emailInput,
    disabled,
    eyeCloseIcon,
    eyeIcon, eyeHandleChange, clientInput1,
    smallWhiteBg,
    name,
    value,
  } = props
