...
export default function SearchSelect(props) {
    ...
    const { icon, options, onChange, name, value, onClick, buttonName, width, clearShow, handleClearClick, labelText, disabled, helperText, referenceID, multiple, ...rest } =
        props;
    ...
    const displayedOptions = options
        .map((item) => {
            ...
            if (item.value) {
                ...
                if (item.check_date.includes(searchText)) {
                    return item;
                }
